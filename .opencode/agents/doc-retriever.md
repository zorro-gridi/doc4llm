...
User Query
    │
    ├───▶ invoke md-doc-query-optimizer skill
             │
             ├───▶ return doc_set, query, reranker_threshold, domain_nouns, predicate_verbs ──▶ for md-doc-searcher
             │
             └───────────── CONCURRENT ─────────────┐
                                                    ▼
                                        invoke md-doc-query-router skill
                                                  │
             ┌────────────────────────────────────┘
             │               return scene ──▶ for md-doc-processor & for md-doc-sence-output
             │
             ▼
invoke md-doc-searcher skill ──▶ return page_title, headings, doc_set ──▶ for md-doc-reader
                                                     │
                                                     ▼
invoke md-doc-reader skill ──▶ return full_doc_content, line_count, doc_meta ──▶ for md-doc-processor
                                                                      │
                                                                      ▼
invoke md-doc-processor skill ──▶ return processed_doc, compression_meta, doc_meta ──▶ for md-doc-sence-output
                                                                               │
                                                                               ▼
                                                                        Final User Response
```
...
| `base_dir` | `.opencode/knowledge_base.json` | 知识库根目录 |
